...
def main() -> None:
    ...
    table = sqlalchemy.Table(
        ...
        sqlalchemy.Column('url', sqlalchemy.Text,
                          nullable=False, index=True),
        sqlalchemy.Column('statuscode', sqlalchemy.String(8),
                          nullable=False, index=True),
        sqlalchemy.Column('bytes', sqlalchemy.Integer, nullable=False),
        sqlalchemy.Column('refferer', sqlalchemy.Text, nullable=False),
        sqlalchemy.Column('useragent', sqlalchemy.Text, nullable=False),
    )
    metadata.create_all()
